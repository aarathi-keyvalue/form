...
import AddMore from "../../deals/components/AddMore";
import DealFormSchema from "../../deals/DealFormValidation";
  ...
  return (
    <div className="py-7">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div>
          <div className="font-semibold text-lg pt-10 pb-4">Deal Documents</div>
            ...
            {docFields.map((document, index) => (
              ...
              >
                ...
                <TextArea
                  ...
                  placeholder="Description"
                  error={errors.document && errors.document[index].description}
                  register={register}
                />
                <FileUploader
